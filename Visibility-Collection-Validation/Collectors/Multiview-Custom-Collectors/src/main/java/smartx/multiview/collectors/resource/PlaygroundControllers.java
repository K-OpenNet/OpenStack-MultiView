...
public class PlaygroundControllers implements Runnable{
	...
	private String Cloud_Controller_User, Cloud_Controller_Password;
	private String Access_Controller_User, Access_Controller_Password;
	private String WAN_Controller_User, WAN_Controller_Password;
	...
	public PlaygroundControllers(MongoDB_Connector MongoConn, String wUser, String wPassword, String cUser, String cPassword, String aUser, String aPassword)
	{
	...
	public void getControllerStatus()
	{
		...
		controllerList.forEach(new Block<Document>() {
			...
			public void apply(final Document document) {
		    	...
		    	String pingCmd = "ping -w 2 -c 1 "+controllerIP;
		    	...
		    	if (controllerStatus.equals("ORANGE"))
		    	{
			    	...
			    	{
			    		checkService(controllerIP, "ps aux | grep horizon", controllerUser, controllerPass);
			    	}
