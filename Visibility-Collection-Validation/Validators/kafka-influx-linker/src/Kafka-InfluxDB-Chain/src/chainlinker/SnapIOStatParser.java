...
public class SnapIOStatParser extends SnapPluginParser {
	...
	public SnapIOStatParser() {
		...
		// Pattern: /intel/linux/iostat/device/(alphanumerical(lowercase only) or ALL)/(rrqm_per_sec or wrqm_per_sec or r_per_sec or w_per_sec or rkB_per_sec or wkB_per_sec)
		...
		// Pattern: /intel/linux/iostat/device/(alphanumerical(lowercase only) or ALL)/(avgrq-sz or avgqu-sz or await or r_await or w_await or svctm or %util)
