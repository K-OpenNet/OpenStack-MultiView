...
#
# Name          : SmartX_Box_Install.sh
# Description   : Script for Installing Dependencies on Smart Box or SmartX Micro-Box
#
...
echo "[$(date '+%Y-%m-%d %H:%M:%S')][INFO][INSTALL] Multi-View Installation on SmartX Box is Started..."
